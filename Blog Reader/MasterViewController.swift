...
//        if let blogArray = jsonObject as? NSArray{
//            if let aStatus = blogArray[0] as? NSDictionary{
//                if let item = aStatus["item"] as? NSDictionary{
//                    if let author = user["name"] as? NSDictionary{
